...
public class Aims {
    ...
    public static void main(String[] args) {
        ...
        store.addMedia(new Book(2, "Harry Potter", "Fantasy", 15.0f));
        store.addMedia(new CompactDisc(3, "Hybrid Theory", "Rock", 10.0f, "Linkin Park", 45, "Chester"));
    ...
    public static void updateStore() {
        ...
        String title = scanner.nextLine();
        if (option == 1) {
            store.addMedia(new Book(99, title, "Unknown", 0));
        } else if (option == 2) {
            Media media = store.searchByTitle(title);
